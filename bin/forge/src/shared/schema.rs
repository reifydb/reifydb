...
pub fn migrations() -> Vec<Migration> {
	vec![
		Migration::new("001_create_forge_namespace", "CREATE NAMESPACE forge;"),
		Migration::new(
		...
		Migration::new(
			...
			"CREATE TABLE forge::job_dependencies { \
				id: Uuid4, \
				job_id: Uuid4, \
