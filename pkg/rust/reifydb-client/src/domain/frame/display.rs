...
//         // RowNumber column
//         let first_data_line = lines[3]; // Fourth line contains first data
// row         assert!(first_data_line.contains("1")); // First RowNumber value
//     }
//
//     #[test]
...
//         assert!(second_data_line.contains("Undefined")); // Second value
// should be undefined     }
//
//     #[test]
//     fn test_blob() {
