...
//
// 		// Insert into table 1
// 		client.command(&format!("from [{{ id: 1, name: 'alice' }}] insert test.{}", table1), None).await.unwrap();
//
...
//
// 		// Insert into table 2
// 		client.command(&format!("from [{{ id: 2, value: 200 }}] insert test.{}", table2), None).await.unwrap();
//
...
// 			client
// 				.command(&format!("from [{{ id: {}, value: {} }}] insert test.{}", i, i * 100, table), None)
// 				.await
// 				.unwrap();
// 		}
//
...
// 		for i in 0..10 {
// 			client
// 				.command(&format!("from [{{ id: {}, value: {} }}] insert test.{}", i, i * 10, table), None)
// 				.await
// 				.unwrap();
// 		}
//
...
// 		trigger_client.command(&format!("from [{{ id: 999 }}] insert test.{}", shared_table), None).await.unwrap();
