...
describe('UNDEFINED_VALUE parsing', () => {
    ...
    it('should parse UNDEFINED_VALUE as undefined for RowNumber', () => {
        const rowId = RowNumberValue.parse(undefinedString);
    ...
    it('should parse UNDEFINED_VALUE for UndefinedValue', () => {
        const undefinedValue = UndefinedValue.parse(undefinedString);
