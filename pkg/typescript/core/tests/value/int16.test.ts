...
describe('Int16', () => {
    describe('constructor', () => {
        ...
        it('should accept minimum value -170141183460469231731687303715884105728', () => {
            const int16 = new Int16(BigInt("-170141183460469231731687303715884105728"));
        ...
        it('should accept maximum value 170141183460469231731687303715884105727', () => {
            const int16 = new Int16(BigInt("170141183460469231731687303715884105727"));
            expect(int16.value).toBe(BigInt("170141183460469231731687303715884105727"));
        });

        it('should accept zero', () => {
            const int16 = new Int16(0);
            expect(int16.value).toBe(BigInt(0));
        });

        it('should accept very large positive number', () => {
            const int16 = new Int16(BigInt("100000000000000000000000000000000000"));
        ...
        it('should accept number beyond JavaScript safe integer range', () => {
            const int16 = new Int16("9999999999999999999999999999999999999");
            expect(int16.value).toBe(BigInt("9999999999999999999999999999999999999"));
        });

        it('should throw error for invalid string value', () => {
            expect(() => new Int16("not a number")).toThrow('Int16 value must be a valid integer, got not a number');
        });

        it('should throw error for value below minimum', () => {
            expect(() => new Int16(BigInt("-170141183460469231731687303715884105729"))).toThrow('Int16 value must be between -170141183460469231731687303715884105728 and 170141183460469231731687303715884105727, got -170141183460469231731687303715884105729');
        });

        it('should throw error for value above maximum', () => {
            expect(() => new Int16(BigInt("170141183460469231731687303715884105728"))).toThrow('Int16 value must be between -170141183460469231731687303715884105728 and 170141183460469231731687303715884105727, got 170141183460469231731687303715884105728');
        });
    });

    describe('parse', () => {
        it('should parse valid integer string', () => {
            const int16 = Int16.parse('100000');
            expect(int16.value).toBe(BigInt(100000));
        });
        ...
        it('should parse minimum value string', () => {
            const int16 = Int16.parse('-170141183460469231731687303715884105728');
            expect(int16.value).toBe(BigInt("-170141183460469231731687303715884105728"));
        });

        it('should parse maximum value string', () => {
            const int16 = Int16.parse('170141183460469231731687303715884105727');
            expect(int16.value).toBe(BigInt("170141183460469231731687303715884105727"));
        });

        it('should parse zero string', () => {
            const int16 = Int16.parse('0');
            expect(int16.value).toBe(BigInt(0));
        });

        it('should parse very large positive number string', () => {
            const int16 = Int16.parse('100000000000000000000000000000000000');
            expect(int16.value).toBe(BigInt("100000000000000000000000000000000000"));
        });
        ...
        it('should throw error for non-numeric string', () => {
            expect(() => Int16.parse('abc')).toThrow('Cannot parse "abc" as Int16');
        });

        it('should throw error for mixed alphanumeric', () => {
            expect(() => Int16.parse('100000abc')).toThrow('Cannot parse "100000abc" as Int16');
        });

        it('should throw error for value outside range', () => {
            expect(() => Int16.parse('170141183460469231731687303715884105728')).toThrow('Int16 value must be between -170141183460469231731687303715884105728 and 170141183460469231731687303715884105727, got 170141183460469231731687303715884105728');
        });

        it('should throw error for decimal string', () => {
            expect(() => Int16.parse('42.5')).toThrow('Cannot parse "42.5" as Int16');
        });
    });
