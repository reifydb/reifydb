...
describe('Uint16', () => {
    describe('constructor', () => {
        ...
        it('should accept number beyond JavaScript safe integer range', () => {
            const uint16 = new Uint16("99999999999999999999999999999999999999");
            expect(uint16.value).toBe(BigInt("99999999999999999999999999999999999999"));
        });

        it('should throw error for invalid string value', () => {
            expect(() => new Uint16("not a number")).toThrow('Uint16 value must be a valid integer, got not a number');
        });

        it('should throw error for negative value', () => {
            expect(() => new Uint16(BigInt(-1))).toThrow('Uint16 value must be between 0 and 340282366920938463463374607431768211455, got -1');
        });

        it('should throw error for value above maximum', () => {
            expect(() => new Uint16(BigInt("340282366920938463463374607431768211456"))).toThrow('Uint16 value must be between 0 and 340282366920938463463374607431768211455, got 340282366920938463463374607431768211456');
        });
    });

    describe('parse', () => {
        it('should parse valid integer string', () => {
            const uint16 = Uint16.parse('1000000');
            expect(uint16.value).toBe(BigInt(1000000));
        });

        it('should parse minimum value string', () => {
            const uint16 = Uint16.parse('0');
            expect(uint16.value).toBe(BigInt(0));
        });

        it('should parse maximum value string', () => {
            const uint16 = Uint16.parse('340282366920938463463374607431768211455');
            expect(uint16.value).toBe(BigInt("340282366920938463463374607431768211455"));
        });

        it('should parse very large positive number string', () => {
            const uint16 = Uint16.parse('100000000000000000000000000000000000');
            expect(uint16.value).toBe(BigInt("100000000000000000000000000000000000"));
        });
        ...
        it('should throw error for non-numeric string', () => {
            expect(() => Uint16.parse('abc')).toThrow('Cannot parse "abc" as Uint16');
        });

        it('should throw error for mixed alphanumeric', () => {
            expect(() => Uint16.parse('1000000abc')).toThrow('Cannot parse "1000000abc" as Uint16');
        });

        it('should throw error for negative value string', () => {
            expect(() => Uint16.parse('-1')).toThrow('Uint16 value must be between 0 and 340282366920938463463374607431768211455, got -1');
        });

        it('should throw error for value outside range', () => {
            expect(() => Uint16.parse('340282366920938463463374607431768211456')).toThrow('Uint16 value must be between 0 and 340282366920938463463374607431768211455, got 340282366920938463463374607431768211456');
        });

        it('should throw error for decimal string', () => {
            expect(() => Uint16.parse('42.5')).toThrow('Cannot parse "42.5" as Uint16');
        });
    });
