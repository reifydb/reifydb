...
import {useAdminOne, useAdminMany, getConnection, clearConnection, Schema} from '../../../src';
import {waitForDatabaseHttp} from '../setup';

describe('useAdmin with TypeScript Primitive Types (HTTP)', () => {
    beforeAll(async () => {
    ...
    describe('useAdminMany with mixed schemas', () => {
