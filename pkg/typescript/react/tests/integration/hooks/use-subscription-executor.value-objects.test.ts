...
describe('useSubscriptionExecutor - Value Object Schema Transformations', () => {
    ...
    describe('Integer Value Objects', () => {
        it('should transform to Int4 Value objects', async () => {
            ...
            await act(async () => {
                ...
                await client!.command(`from [{ id: 1, value: 2147483647 }] insert test.${tableName}`, null, []);
            });
        ...
        it('should transform to Int8 Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, bigValue: 9007199254740991 }] insert test.${tableName}`, null, []);
            });
        ...
        it('should transform to Uint4 Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, unsigned: 4294967295 }] insert test.${tableName}`, null, []);
            });
        ...
        it('should transform to Uint8 Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, bigUnsigned: 18446744073709551615 }] insert test.${tableName}`, null, []);
            });
    ...
    describe('Float Value Objects', () => {
        it('should transform to Float4 Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, floatValue: 3.14 }] insert test.${tableName}`, null, []);
            });
        ...
        it('should transform to Float8 Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, doubleValue: 2.718281828459045 }] insert test.${tableName}`, null, []);
            });
    ...
    describe('String Value Objects', () => {
        it('should transform to Utf8 Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, text: 'Hello, World!' }] insert test.${tableName}`, null, []);
            });
    ...
    describe('Boolean Value Objects', () => {
        it('should transform to Boolean Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, flag: true }, { id: 2, flag: false }] insert test.${tableName}`, null, []);
            });
    ...
    describe('Mixed Value Objects', () => {
        it('should handle mixed Value object types', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, count: 100, ratio: 0.95, name: 'Alice', active: true }] insert test.${tableName}`, null, []);
            });
    ...
    describe('Operations with Value Objects', () => {
        it('should handle INSERT with Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, value: 42 }] insert test.${tableName}`, null, []);
            });
        ...
        it('should handle UPDATE with Value objects', async () => {
            ...
            const client = getConnection().getClient();
            await act(async () => {
                await client!.command(`from [{ id: 1, score: 85.5 }] insert test.${tableName}`, null, []);
            });
            ...
            // Now do UPDATE
            await act(async () => {
                await client!.command(`from test.${tableName} filter id == 1 map {id, score: 92.0} update test.${tableName}`, null, []);
            });
        ...
        it('should handle REMOVE with Value objects', async () => {
            ...
            const client = getConnection().getClient();
            await act(async () => {
                await client!.command(`from [{ id: 1, name: 'to_delete' }] insert test.${tableName}`, null, []);
            });
            ...
            // Now do REMOVE
            await act(async () => {
                await client!.command(`from test.${tableName} filter id == 1 delete test.${tableName}`, null, []);
            });
        ...
        it('should maintain Value object types across multiple operations', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, counter: 0 }] insert test.${tableName}`, null, []);
            });
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from test.${tableName} filter id == 1 map {id, counter: 5} update test.${tableName}`, null, []);
            });
    ...
    describe('Value Property Access', () => {
        it('should verify .value property access on Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, amount: 1000, rate: 0.05, label: 'Premium' }] insert test.${tableName}`, null, []);
            });
        ...
        it('should handle batch operations with Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from ${JSON.stringify(rows)} insert test.${tableName}`, null, []);
            });
    ...
    describe('Edge Cases', () => {
        it('should handle mixed primitives and Value objects', async () => {
            ...
            await act(async () => {
                const client = getConnection().getClient();
                await client!.command(`from [{ id: 1, count: 100, name: 'Test' }] insert test.${tableName}`, null, []);
            });
