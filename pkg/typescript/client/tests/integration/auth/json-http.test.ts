...
describe('Auth Login Tests — JSON HTTP', () => {
    ...
    describe('Password Authentication', () => {
        it('should login with correct password and execute queries', async () => {
            const client = Client.connectJsonHttp(HTTP_URL, {timeoutMs: 10000});
    ...
    describe('Logout', () => {
        it('should logout and revoke token', async () => {
            ...
            const client2 = Client.connectJsonHttp(HTTP_URL, {timeoutMs: 10000, token: oldToken});
        ...
        it('should not affect other sessions', async () => {
            const clientA = Client.connectJsonHttp(HTTP_URL, {timeoutMs: 10000});
            const clientB = Client.connectJsonHttp(HTTP_URL, {timeoutMs: 10000});
