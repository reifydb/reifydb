...
describe('Auth Login Tests — WebSocket', () => {
    ...
    describe('Password Authentication', () => {
        ...
        it('should login with correct password and execute queries', async () => {
            client = await Client.connectWs(WS_URL, {timeoutMs: 10000});
    ...
    describe('Logout', () => {
        ...
        it('should logout and revoke token', async () => {
            ...
            const client2 = await Client.connectWs(WS_URL, {timeoutMs: 10000, token: oldToken});
        ...
        it('should not affect other sessions', async () => {
            const clientA = await Client.connectWs(WS_URL, {timeoutMs: 10000});
            const clientB = await Client.connectWs(WS_URL, {timeoutMs: 10000});
