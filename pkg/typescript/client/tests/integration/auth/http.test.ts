...
describe('Auth Login Tests — HTTP', () => {
    ...
    describe('Password Authentication', () => {
        it('should login with correct password and execute queries', async () => {
            const client = Client.connectHttp(HTTP_URL, {timeoutMs: 10000});
    ...
    describe('Logout', () => {
        it('should logout and revoke token', async () => {
            ...
            const client2 = Client.connectHttp(HTTP_URL, {timeoutMs: 10000, token: oldToken});
        ...
        it('should not affect other sessions', async () => {
            const clientA = Client.connectHttp(HTTP_URL, {timeoutMs: 10000});
            const clientB = Client.connectHttp(HTTP_URL, {timeoutMs: 10000});
