...
describe('Auth Login Tests — HTTP', () => {
    ...
    describe('Password Authentication', () => {
        it('should login with correct password and execute queries', async () => {
            const client = Client.connect_http(HTTP_URL, {timeout_ms: 10000});
    ...
    describe('Logout', () => {
        it('should logout and revoke token', async () => {
            ...
            const client2 = Client.connect_http(HTTP_URL, {timeout_ms: 10000, token: oldToken});
        ...
        it('should not affect other sessions', async () => {
            const clientA = Client.connect_http(HTTP_URL, {timeout_ms: 10000});
            const clientB = Client.connect_http(HTTP_URL, {timeout_ms: 10000});
