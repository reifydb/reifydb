...
describe('Positional Parameters (value)', () => {
    ...
    describe('admin', () => {
        ...
        it('None', async () => {
            const frames = await httpClient.admin('MAP {result: $1}', [new NoneValue('Int4')]);
    ...
    describe('command', () => {
        ...
        it('None', async () => {
            const frames = await httpClient.command('MAP {result: $1}', [new NoneValue('Int4')]);
            expectSingleValueResult(frames, new NoneValue('Int4'));
        }, 1000);
    ...
    describe('query', () => {
        ...
        it('None', async () => {
            const frames = await httpClient.query('MAP {result: $1}', [new NoneValue('Int4')]);
            expectSingleValueResult(frames, new NoneValue('Int4'));
        }, 1000);
