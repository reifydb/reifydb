    ...
    pub(crate) fn less_than(
        ...
        match (&left.values(), &right.values()) {
            ...
            (ColumnValues::Float4(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<f32, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<f32, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<f32, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<f32, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<f32, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<f32, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<f32, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<f32, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<f32, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<f32, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<f32, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float4(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<f32, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Float8
            (ColumnValues::Float8(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<f64, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<f64, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<f64, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<f64, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<f64, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<f64, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<f64, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<f64, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<f64, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<f64, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<f64, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Float8(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<f64, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Int1
            (ColumnValues::Int1(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<i8, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<i8, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<i8, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<i8, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<i8, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<i8, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<i8, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<i8, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<i8, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<i8, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<i8, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int1(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<i8, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Int2
            (ColumnValues::Int2(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<i16, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<i16, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<i16, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<i16, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<i16, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<i16, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<i16, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<i16, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<i16, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<i16, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<i16, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int2(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<i16, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Int4
            (ColumnValues::Int4(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<i32, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<i32, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<i32, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<i32, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<i32, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<i32, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<i32, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<i32, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<i32, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<i32, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<i32, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int4(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<i32, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Int8
            (ColumnValues::Int8(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<i64, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<i64, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<i64, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<i64, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<i64, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<i64, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<i64, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<i64, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<i64, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<i64, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<i64, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int8(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<i64, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Int16
            (ColumnValues::Int16(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<i128, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<i128, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<i128, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<i128, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<i128, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<i128, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<i128, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<i128, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<i128, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<i128, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<i128, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Int16(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<i128, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Uint1
            (ColumnValues::Uint1(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<u8, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<u8, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<u8, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<u8, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<u8, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<u8, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<u8, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<u8, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<u8, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<u8, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<u8, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint1(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<u8, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Uint2
            (ColumnValues::Uint2(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<u16, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<u16, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<u16, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<u16, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<u16, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<u16, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<u16, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<u16, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<u16, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<u16, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<u16, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint2(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<u16, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Uint4
            (ColumnValues::Uint4(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<u32, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<u32, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<u32, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<u32, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<u32, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<u32, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<u32, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<u32, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<u32, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<u32, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<u32, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint4(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<u32, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Uint8
            (ColumnValues::Uint8(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<u64, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<u64, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<u64, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<u64, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<u64, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<u64, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<u64, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<u64, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<u64, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<u64, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<u64, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint8(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<u64, u128>(ctx, l, r, lv, rv, lt.span()))
            }
            // Uint16
            (ColumnValues::Uint16(l, lv), ColumnValues::Float4(r, rv)) => {
                Ok(compare_number::<u128, f32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Float8(r, rv)) => {
                Ok(compare_number::<u128, f64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Int1(r, rv)) => {
                Ok(compare_number::<u128, i8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Int2(r, rv)) => {
                Ok(compare_number::<u128, i16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Int4(r, rv)) => {
                Ok(compare_number::<u128, i32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Int8(r, rv)) => {
                Ok(compare_number::<u128, i64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Int16(r, rv)) => {
                Ok(compare_number::<u128, i128>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Uint1(r, rv)) => {
                Ok(compare_number::<u128, u8>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Uint2(r, rv)) => {
                Ok(compare_number::<u128, u16>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Uint4(r, rv)) => {
                Ok(compare_number::<u128, u32>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Uint8(r, rv)) => {
                Ok(compare_number::<u128, u64>(ctx, l, r, lv, rv, lt.span()))
            }
            (ColumnValues::Uint16(l, lv), ColumnValues::Uint16(r, rv)) => {
                Ok(compare_number::<u128, u128>(ctx, l, r, lv, rv, lt.span()))
            }
