...
use reifydb_type::{
	Decimal, Fragment, Int, IsNumber, IsTemporal, Promote, Type::Boolean,
	Uint,
...
impl StandardEvaluator {
	pub(crate) fn equal(
		...
		match (&left.data(), &right.data()) {
			...
			) => Ok(compare_number::<Uint, Decimal>(
				ctx,
				l,
				r,
				eq.full_fragment_owned(),
			...
			(
				...
				ColumnData::Uint(r),
			) => Ok(compare_number::<Decimal, Uint>(
				ctx,
				l,
				r,
				eq.full_fragment_owned(),
