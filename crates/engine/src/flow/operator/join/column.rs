...
impl JoinedColumnsBuilder {
	...
	pub(crate) fn join_one_to_many(
		...
		Columns::with_system(
			result_columns,
			SystemColumns::new(row_numbers.to_vec(), Vec::new(), Self::duplicate_timestamp(left.created_at(), left_idx, right_count), Self::duplicate_timestamp(left.updated_at(), left_idx, right_count), Vec::new()),
		)
	}
	...
	pub(crate) fn join_many_to_one(
		...
		Columns::with_system(
			result_columns,
			SystemColumns::new(row_numbers.to_vec(), Vec::new(), left.created_at().as_ref().to_vec(), left.updated_at().as_ref().to_vec(), left.time().to_vec()),
		)
	}
	...
	pub(crate) fn join_cartesian(
		...
		Columns::with_system(
			result_columns,
			SystemColumns::new(row_numbers.to_vec(), Vec::new(), Self::expand_timestamps_cartesian(left.created_at(), left_indices, right_count), Self::expand_timestamps_cartesian(left.updated_at(), left_indices, right_count), Vec::new()),
		)
	}
	...
	pub(crate) fn unmatched_left(
		...
		Columns::with_system(
			result_columns,
			SystemColumns::new(vec![row_number], Vec::new(), Self::extract_single_timestamp(left.created_at(), left_idx), Self::extract_single_timestamp(left.updated_at(), left_idx), Vec::new()),
		)
	}
	...
	pub(crate) fn unmatched_left_batch(
		...
		Columns::with_system(
			result_columns,
			SystemColumns::new(row_numbers.to_vec(), Vec::new(), Self::extract_timestamps_at_indices(left.created_at(), left_indices), Self::extract_timestamps_at_indices(left.updated_at(), left_indices), Vec::new()),
		)
	}
