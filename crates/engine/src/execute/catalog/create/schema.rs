...
mod tests {
    ...
    fn test_create_schema() {
        ...
        let result = execute_command(&mut atx, PhysicalPlan::CreateSchema(plan.clone()), Params::default()).unwrap();
        ...
        let err = execute_command(&mut atx, PhysicalPlan::CreateSchema(plan), Params::default()).unwrap_err();
