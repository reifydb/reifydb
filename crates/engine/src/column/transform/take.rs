...
mod tests {
    ...
    fn test_bool_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::bool_with_bitvec([true], [false])
        );
    }
    ...
    fn test_float4_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::float4_with_bitvec([1.0, 2.0], [true, false])
        );
    }
    ...
    fn test_float8_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::float8_with_bitvec([1.0, 2.0], [true, true])
        );
    }
    ...
    fn test_int1_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::int1_with_bitvec([1, 2], [true, false])
        );
    }
    ...
    fn test_int2_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::int2_with_bitvec([1, 2], [true, true])
        );
    }
    ...
    fn test_int4_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::int4_with_bitvec([1], [true])
        );
    }
    ...
    fn test_int8_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::int8_with_bitvec([1, 2], [false, true])
        );
    }
    ...
    fn test_int16_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::int16_with_bitvec([1], [true])
        );
    }
    ...
    fn test_uint1_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::uint1_with_bitvec([1, 2], [false, false])
        );
    }
    ...
    fn test_uint2_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::uint2_with_bitvec([1], [true])
        );
    }
    ...
    fn test_uint4_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::uint4_with_bitvec([10], [false])
        );
    }
    ...
    fn test_uint8_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::uint8_with_bitvec([10, 20], [true, true])
        );
    }
    ...
    fn test_uint16_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::uint16_with_bitvec([100], [true])
        );
    }
    ...
    fn test_text_column() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::utf8_with_bitvec(["a".to_string(), "b".to_string()], [true, false])
        );
    }
    ...
    fn test_handles_undefined() {
        ...
        match &test_instance.columns[0].data() {
            EngineColumnData::Undefined(container) => assert_eq!(container.len(), 3),
            _ => panic!("Expected Undefined column"),
        }
    }
    ...
    fn test_n_larger_than_len_is_safe() {
        ...
        assert_eq!(
            *test_instance.columns[0].data(),
            EngineColumnData::int2_with_bitvec([10, 20], [true, false])
        );
    }
}
