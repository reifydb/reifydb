...
mod tests {
    ...
    fn test_undefined_column() {
        let mut test_instance = Columns::new(vec![TableQualified::undefined("test_frame", "u", 3)]);
    ...
    fn test_handles_undefined() {
        let mut test_instance = Columns::new(vec![TableQualified::undefined("test_frame", "u", 5)]);
