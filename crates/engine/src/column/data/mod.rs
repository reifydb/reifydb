...
impl ColumnData {
    ...
    pub fn is_defined(&self, idx: usize) -> bool {
        match self {
            ...
            ColumnData::Utf8(container) => container.is_defined(idx),
