...
mod tests {
	...
	fn test_abs_int1_fully_defined() {
		...
		let column = ColumnComputed::int1("test", data.clone());
	...
	fn test_abs_int1_partially_defined() {
		...
		let column = ColumnComputed::int1_with_bitvec("test", data.clone(), bitvec.clone());
	...
	fn test_abs_int2_fully_defined() {
		...
		let column = ColumnComputed::int2("test", data.clone());
