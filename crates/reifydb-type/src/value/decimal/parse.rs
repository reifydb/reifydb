...
use crate::{
	Error, IntoFragment, error::diagnostic::number::invalid_number_format,
	return_error, value::decimal::Decimal,
};
...
pub fn parse_decimal<'a>(
	...
	let precision = crate::value::decimal::Precision::new(precision_u8);
