...
pub fn value_max<'a>(value: Type) -> &'a str {
	match value {
		...
		Type::Int16 => "170_141_183_460_469_231_731_687_303_715_884_105_727",
		Type::Utf8 => unreachable!(),
		Type::Uint1 => "255",
		Type::Uint2 => "65_535",
		Type::Uint4 => "4_294_967_295",
		Type::Uint8 => "18_446_744_073_709_551_615",
		Type::Uint16 => "340_282_366_920_938_463_463_374_607_431_768_211_455",
		Type::Date => unreachable!(),
		Type::DateTime => unreachable!(),
		Type::Time => unreachable!(),
		Type::Duration => unreachable!(),
		Type::IdentityId => unreachable!(),
...
pub fn value_range<'a>(value: Type) -> &'a str {
	match value {
		...
		Type::Int8 => "-9_223_372_036_854_775_808 to 9_223_372_036_854_775_807",
		Type::Int16 => {
		...
		Type::Uint16 => "0 to 340_282_366_920_938_463_463_374_607_431_768_211_455",
		Type::Date => unreachable!(),
		Type::DateTime => unreachable!(),
		Type::Time => unreachable!(),
		Type::Duration => unreachable!(),
...
pub mod tests {
	...
	mod value_max {
		use crate::{error::util::value_max, value::r#type::Type};
		...
		fn test_signed_ints() {
			...
			assert_eq!(value_max(Type::Int16), "170_141_183_460_469_231_731_687_303_715_884_105_727");
		}
		...
		fn test_unsigned_ints() {
			...
			assert_eq!(value_max(Type::Uint16), "340_282_366_920_938_463_463_374_607_431_768_211_455");
		}
	...
	mod value_range {
		use crate::{error::util::value_range, value::r#type::Type};
		...
		fn test_signed_ints() {
			...
			assert_eq!(value_range(Type::Int8), "-9_223_372_036_854_775_808 to 9_223_372_036_854_775_807");
			assert_eq!(
