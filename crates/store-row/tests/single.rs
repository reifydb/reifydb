...
test_each_path! { in "crates/store-row/tests/scripts/single" as single_memory => test_memory }
test_each_path! { in "crates/store-row/tests/scripts/single" as single_sqlite => test_sqlite }
