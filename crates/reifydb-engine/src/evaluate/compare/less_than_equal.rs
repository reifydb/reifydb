...
use reifydb_core::{
	OwnedSpan,
	Type::Bool,
	interface::evaluate::expression::LessThanEqualExpression,
	...
	pub(crate) fn less_than_equal(
		...
		match (&left.data(), &right.data()) {
            ...
            (ColumnData::Float4(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<f32, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<f32, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<f32, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<f32, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<f32, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<f32, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<f32, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<f32, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<f32, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<f32, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float4(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<f32, u128>(ctx, l, r, lte.span()))
            }
            // Float8
            (ColumnData::Float8(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<f64, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<f64, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<f64, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<f64, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<f64, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<f64, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<f64, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<f64, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<f64, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<f64, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<f64, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Float8(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<f64, u128>(ctx, l, r, lte.span()))
            }
            // Int1
            (ColumnData::Int1(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<i8, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<i8, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<i8, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<i8, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<i8, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<i8, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<i8, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<i8, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<i8, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<i8, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<i8, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int1(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<i8, u128>(ctx, l, r, lte.span()))
            }
            // Int2
            (ColumnData::Int2(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<i16, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<i16, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<i16, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<i16, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<i16, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<i16, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<i16, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<i16, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<i16, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<i16, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<i16, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int2(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<i16, u128>(ctx, l, r, lte.span()))
            }
            // Int4
            (ColumnData::Int4(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<i32, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<i32, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<i32, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<i32, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<i32, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<i32, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<i32, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<i32, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<i32, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<i32, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<i32, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int4(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<i32, u128>(ctx, l, r, lte.span()))
            }
            // Int8
            (ColumnData::Int8(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<i64, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<i64, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<i64, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<i64, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<i64, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<i64, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<i64, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<i64, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<i64, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<i64, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<i64, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int8(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<i64, u128>(ctx, l, r, lte.span()))
            }
            // Int16
            (ColumnData::Int16(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<i128, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<i128, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<i128, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<i128, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<i128, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<i128, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<i128, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<i128, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<i128, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<i128, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<i128, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Int16(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<i128, u128>(ctx, l, r, lte.span()))
            }
            // Uint1
            (ColumnData::Uint1(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<u8, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<u8, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<u8, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<u8, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<u8, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<u8, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<u8, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<u8, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<u8, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<u8, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<u8, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint1(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<u8, u128>(ctx, l, r, lte.span()))
            }
            // Uint2
            (ColumnData::Uint2(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<u16, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<u16, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<u16, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<u16, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<u16, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<u16, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<u16, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<u16, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<u16, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<u16, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<u16, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint2(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<u16, u128>(ctx, l, r, lte.span()))
            }
            // Uint4
            (ColumnData::Uint4(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<u32, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<u32, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<u32, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<u32, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<u32, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<u32, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<u32, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<u32, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<u32, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<u32, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<u32, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint4(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<u32, u128>(ctx, l, r, lte.span()))
            }
            // Uint8
            (ColumnData::Uint8(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<u64, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<u64, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<u64, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<u64, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<u64, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<u64, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<u64, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<u64, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<u64, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<u64, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<u64, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint8(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<u64, u128>(ctx, l, r, lte.span()))
            }
            // Uint16
            (ColumnData::Uint16(l), ColumnData::Float4(r)) => {
                Ok(compare_number::<u128, f32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Float8(r)) => {
                Ok(compare_number::<u128, f64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Int1(r)) => {
                Ok(compare_number::<u128, i8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Int2(r)) => {
                Ok(compare_number::<u128, i16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Int4(r)) => {
                Ok(compare_number::<u128, i32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Int8(r)) => {
                Ok(compare_number::<u128, i64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Int16(r)) => {
                Ok(compare_number::<u128, i128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Uint1(r)) => {
                Ok(compare_number::<u128, u8>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Uint2(r)) => {
                Ok(compare_number::<u128, u16>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Uint4(r)) => {
                Ok(compare_number::<u128, u32>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Uint8(r)) => {
                Ok(compare_number::<u128, u64>(ctx, l, r, lte.span()))
            }
            (ColumnData::Uint16(l), ColumnData::Uint16(r)) => {
                Ok(compare_number::<u128, u128>(ctx, l, r, lte.span()))
            }
            (ColumnData::Date(l), ColumnData::Date(r)) => Ok(compare_temporal(l, r, lte.span())),
            (ColumnData::DateTime(l), ColumnData::DateTime(r)) => {
                Ok(compare_temporal(l, r, lte.span()))
            }
            (ColumnData::Time(l), ColumnData::Time(r)) => Ok(compare_temporal(l, r, lte.span())),
            (ColumnData::Interval(l), ColumnData::Interval(r)) => {
                Ok(compare_temporal(l, r, lte.span()))
            }
            (ColumnData::Utf8(l), ColumnData::Utf8(r)) => Ok(compare_utf8(l, r, lte.span())),
