	...
	pub fn append_columns(&mut self, other: Columns) -> crate::Result<()> {
		if self.len() != other.len() {
			return_error!(engine::frame_error(
				"mismatched column count".to_string()
			));
		}

		for (i, (l, r)) in
			self.iter_mut().zip(other.into_iter()).enumerate()
		{
		...
		for (index, column) in self.iter_mut().enumerate() {
			match (column.data_mut(), layout.value(index)) {
				...
				(
					...
					container.push(layout
						.get_interval(&row, index));
				}
				(ColumnData::Uuid4(container), Type::Uuid4) => {
					container.push(
						layout.get_uuid4(&row, index)
					);
				}
...
mod tests {
	mod columns {
		...
		use crate::columnar::{ColumnQualified, Columns};

		#[test]
		fn test_boolean() {
			let mut test_instance1 = Columns::new(vec![
				ColumnQualified::bool_with_bitvec(
					"id",
					[true],
					[false],
				),
		...
		fn test_float4() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::float4(
					"id",
					[1.0f32, 2.0],
				)]);
		...
		fn test_float8() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::float8(
					"id",
					[1.0f64, 2.0],
				)]);
		...
		fn test_int1() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::int1(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::int1_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_int2() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::int2(
					"id",
					[1, 2],
				)]);
		...
		fn test_int4() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::int4(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::int4_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_int8() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::int8(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::int8_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_int16() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::int16(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::int16_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_uint1() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::uint1(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::uint1_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_uint2() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::uint2(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::uint2_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_uint4() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::uint4(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::uint4_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_uint8() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::uint8(
					"id",
					[1, 2],
				)]);

			let test_instance2 = Columns::new(vec![
				ColumnQualified::uint8_with_bitvec(
					"id",
					[3, 4],
					[true, false],
				),
		...
		fn test_uint16() {
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::uint16(
					"id",
					[1, 2],
				)]);
		...
		fn test_uuid4() {
			...
			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::uuid4(
					"id",
					[uuid1, uuid2],
				)]);
		...
		fn test_uuid7() {
			...
			let uuid2 = Uuid7::from(Uuid::new_v7(
				Timestamp::from_gregorian(1, 2),
			));
			let uuid3 = Uuid7::from(Uuid::new_v7(
				Timestamp::from_gregorian(2, 1),
			));
			let uuid4 = Uuid7::from(Uuid::new_v7(
				Timestamp::from_gregorian(2, 2),
			));

			let mut test_instance1 =
				Columns::new(vec![ColumnQualified::uuid7(
					"id",
					[uuid1, uuid2],
				)]);
		...
		fn test_with_undefined_lr_promotes_correctly() {
			...
			let test_instance2 =
				Columns::new(vec![ColumnQualified::undefined(
					"id", 2,
				)]);
		...
		fn test_fails_on_column_count_mismatch() {
			...
			let result =
				test_instance1.append_columns(test_instance2);
		...
		fn test_fails_on_type_mismatch() {
			...
			let test_instance2 =
				Columns::new(vec![ColumnQualified::utf8(
					"id",
					["A"],
				)]);
	...
	mod row {
		...
		fn test_before_undefined_float8() {
			...
			layout.set_values(
				&mut row,
				&[Value::Float8(
					OrderedF64::try_from(2.25).unwrap(),
				)],
			);
			test_instance.append_rows(&layout, [row]).unwrap();
		...
		fn test_mismatched_columns() {
			...
			let err = test_instance
				.append_rows(&layout, [row])
				.err()
				.unwrap();
			assert!(err.to_string().contains(
				"mismatched column count: expected 0, got 1"
			));
		}
		...
		fn test_ok() {
			...
			test_instance
				.append_rows(&layout, [row_one, row_two])
				.unwrap();

			assert_eq!(
				*test_instance[0].data(),
				ColumnData::int2([1, 2, 3])
			);
			assert_eq!(
		...
		fn test_all_defined_bool() {
			let mut test_instance =
				Columns::new(vec![ColumnQualified::bool(
					"test_col",
					[],
				)]);
		...
		fn test_all_defined_float4() {
			...
			layout.set_values(
				&mut row_one,
				&[Value::Float4(
					OrderedF32::try_from(1.0).unwrap(),
				)],
			);
			let mut row_two = layout.allocate_row();
			layout.set_values(
		...
		fn test_all_defined_float8() {
			...
			layout.set_values(
				&mut row_one,
				&[Value::Float8(
					OrderedF64::try_from(1.0).unwrap(),
				)],
			);
			let mut row_two = layout.allocate_row();
			layout.set_values(
		...
		fn test_row_wrong_length_fails() {
			...
			assert!(result
				.unwrap_err()
				.to_string()
				.contains("mismatched column count"));
		}
		...
		fn test_fallback_bool() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::bool_with_bitvec([true], [true])
			);

			assert_eq!(
				*test_instance[1].data(),
				ColumnData::bool_with_bitvec([false], [false])
			);
		}
		...
		fn test_fallback_float4() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::float4_with_bitvec([1.5], [true])
			);
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::float4_with_bitvec([0.0], [false])
			);
		}
		...
		fn test_fallback_float8() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::float8_with_bitvec([2.5], [true])
			);
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::float8_with_bitvec([0.0], [false])
			);
		}
		...
		fn test_fallback_int1() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::int1_with_bitvec([42], [true])
			);
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::int1_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_int2() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::int2_with_bitvec([-1234], [true])
			);
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::int2_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_int4() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::int4_with_bitvec([56789], [true])
			);
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::int4_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_int8() {
			...
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::int8_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_int16() {
			...
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::int16_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_uint1() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::uint1_with_bitvec([255], [true])
			);
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::uint1_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_uint2() {
			...
			assert_eq!(
				*test_instance[0].data(),
				ColumnData::uint2_with_bitvec([65535], [true])
			);
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::uint2_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_uint4() {
			...
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::uint4_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_uint8() {
			...
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::uint8_with_bitvec([0], [false])
			);
		}
		...
		fn test_fallback_uint16() {
			...
			assert_eq!(
				*test_instance[1].data(),
				ColumnData::uint16_with_bitvec([0], [false])
			);
		}
