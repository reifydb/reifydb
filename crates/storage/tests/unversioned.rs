...
test_each_path! { in "storage/tests/scripts/unversioned" as unversioned_memory => test_memory }
test_each_path! { in "storage/tests/scripts/unversioned" as unversioned_sqlite => test_sqlite }
