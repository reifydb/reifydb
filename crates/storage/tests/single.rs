...
test_each_path! { in "crates/storage/tests/scripts/single" as single_memory => test_memory }
test_each_path! { in "crates/storage/tests/scripts/single" as single_sqlite => test_sqlite }
