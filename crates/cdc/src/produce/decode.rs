...
pub(crate) fn build_insert_diff(registry: &SchemaRegistry, row_number: RowNumber, post: EncodedRow) -> Option<Diff> {
...
pub(crate) fn build_remove_diff(registry: &SchemaRegistry, row_number: RowNumber, pre: EncodedRow) -> Option<Diff> {
