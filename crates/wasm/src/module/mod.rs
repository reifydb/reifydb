...
impl std::fmt::Display for TrapNotFound {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            TrapNotFound::ExportedFunction(_) => todo!(),
            TrapNotFound::Function(_) => todo!(),
            TrapNotFound::FunctionLocal(_) => todo!(),
            TrapNotFound::FunctionType(_) => todo!(),
            TrapNotFound::Memory(_) => todo!(),
            TrapNotFound::Module(_) => todo!(),
            TrapNotFound::ReturnValue => todo!(),
            TrapNotFound::Table(_) => todo!(),
