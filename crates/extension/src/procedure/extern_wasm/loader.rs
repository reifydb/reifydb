...
use super::ExternWasmProcedure;

pub fn register_extern_wasm_procedures_from_dir(
	dir: &Path,
	...
	for entry in entries {
		...
		builder = builder.register_procedure(Arc::new(ExternWasmProcedure::new(name, wasm_bytes)));
	}
