...
use reifydb_core::interface::subsystem::logging::{
	log, LogBackend, LogLevel, Record,
};
use reifydb_core::interface::subsystem::Subsystem;
use reifydb_core::result::error::diagnostic::internal;
...
// Removed test_restart_subsystem since subsystems are no longer restartable after shutdown
