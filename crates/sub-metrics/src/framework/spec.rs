	...
	pub fn spec(self) -> DomainSpec {
		match self {
			...
			MetricsDomain::Storage => DomainSpec {
				...
				measures: vec![
					level("estimated_live_key_bytes", ValueType::Uint8),
					level("estimated_live_value_bytes", ValueType::Uint8),
					level("estimated_live_bytes", ValueType::Uint8),
					level("estimated_live_count", ValueType::Uint8),
					level("estimated_superseded_key_bytes", ValueType::Uint8),
					level("estimated_superseded_value_bytes", ValueType::Uint8),
					level("estimated_superseded_bytes", ValueType::Uint8),
					level("estimated_superseded_count", ValueType::Uint8),
					level("estimated_total_bytes", ValueType::Uint8),
				],
				has_total: false,
			},
