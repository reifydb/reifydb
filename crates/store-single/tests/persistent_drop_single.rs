...
use reifydb_store_single::{
	config::{PersistentConfig, SingleStoreConfig},
...
test_each_path! { in "crates/store-single/tests/scripts/drop" as persistent_drop_single => test_persistent }

fn test_persistent(path: &Path) {
	temp_dir(|_db_path| {
