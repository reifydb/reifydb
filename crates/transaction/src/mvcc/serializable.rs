...
impl<MVS: MultiVersionStorage, SMVT: SingleVersionTransaction> WithEventBus for Serializable<MVS, SMVT> {
	fn event_bus(&self) -> &EventBus {
		&self.event_bus
	}
}

impl<MVS: MultiVersionStorage, SMVT: SingleVersionTransaction> MultiVersionTransaction for Serializable<MVS, SMVT> {
