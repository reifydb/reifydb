...
impl<MVS: MultiVersionStore, SVT: SingleVersionTransaction> WithEventBus for Serializable<MVS, SVT> {
	fn event_bus(&self) -> &EventBus {
		&self.event_bus
	}
}

impl<MVS: MultiVersionStore, SVT: SingleVersionTransaction> MultiVersionTransaction for Serializable<MVS, SVT> {
