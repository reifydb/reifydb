...
//   txn.set(a999, 100).unwrap();
//   txn.set(a888, 100).unwrap();
//   txn.commit().unwrap();
...
//   assert_eq!(200, sum);
//   txn1.set(a999, 0).unwrap(); // Deduct 100 from a999
//
...
//   assert_eq!(200, sum);
//   txn2.set(a888, 0).unwrap(); // Deduct 100 from a888
//
//   // Let's read this back.
//   let mut sum = get_bal(&mut txn2, &a999);
//   assert_eq!(100, sum);
...
//   for i in 1..=10 {
//     if i % 2 == 1 {
//       txn.set(i, "black").unwrap();
//     } else {
//       txn.set(i, "white").unwrap();
//     }
//   }
//   txn.commit().unwrap();
//
...
//   for i in 1..=9000 {
//     if i % 3 == 1 {
//       txn.set(i, "red").unwrap();
//     } else if i % 3 == 2 {
//       txn.set(i, "yellow").unwrap();
//     } else {
//       txn.set(i, "blue").unwrap();
//     }
//   }
//   txn.commit().unwrap();
//
