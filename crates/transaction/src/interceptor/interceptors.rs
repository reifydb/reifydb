...
pub struct Interceptors {
	...
	pub segment_tree_row_pre_insert: Chain<dyn SegmentTreeRowPreInsertInterceptor + Send + Sync>,
	pub segment_tree_row_post_insert: Chain<dyn SegmentTreeRowPostInsertInterceptor + Send + Sync>,
	pub segment_tree_row_pre_update: Chain<dyn SegmentTreeRowPreUpdateInterceptor + Send + Sync>,
	pub segment_tree_row_post_update: Chain<dyn SegmentTreeRowPostUpdateInterceptor + Send + Sync>,
	pub segment_tree_row_pre_delete: Chain<dyn SegmentTreeRowPreDeleteInterceptor + Send + Sync>,
	pub segment_tree_row_post_delete: Chain<dyn SegmentTreeRowPostDeleteInterceptor + Send + Sync>,
	pub segment_tree_post_create: Chain<dyn SegmentTreePostCreateInterceptor + Send + Sync>,
	pub segment_tree_pre_update: Chain<dyn SegmentTreePreUpdateInterceptor + Send + Sync>,
	pub segment_tree_post_update: Chain<dyn SegmentTreePostUpdateInterceptor + Send + Sync>,
	pub segment_tree_pre_delete: Chain<dyn SegmentTreePreDeleteInterceptor + Send + Sync>,
	...
	pub identity_attribute_post_create: Chain<dyn IdentityAttributePostCreateInterceptor + Send + Sync>,
	pub identity_attribute_pre_delete: Chain<dyn IdentityAttributePreDeleteInterceptor + Send + Sync>,
	pub identity_attribute_value_post_create: Chain<dyn IdentityAttributeValuePostCreateInterceptor + Send + Sync>,
...
impl Interceptors {
	pub fn new() -> Self {
		Self {
			...
			segment_tree_row_pre_insert: InterceptorChain::new(),
			segment_tree_row_post_insert: InterceptorChain::new(),
			segment_tree_row_pre_update: InterceptorChain::new(),
			segment_tree_row_post_update: InterceptorChain::new(),
			segment_tree_row_pre_delete: InterceptorChain::new(),
			segment_tree_row_post_delete: InterceptorChain::new(),
			segment_tree_post_create: InterceptorChain::new(),
			segment_tree_pre_update: InterceptorChain::new(),
			segment_tree_post_update: InterceptorChain::new(),
			segment_tree_pre_delete: InterceptorChain::new(),
			...
			identity_attribute_post_create: InterceptorChain::new(),
			identity_attribute_pre_delete: InterceptorChain::new(),
			identity_attribute_value_post_create: InterceptorChain::new(),
...
impl Clone for Interceptors {
	fn clone(&self) -> Self {
		Self {
			...
			segment_tree_row_pre_insert: self.segment_tree_row_pre_insert.clone(),
			segment_tree_row_post_insert: self.segment_tree_row_post_insert.clone(),
			segment_tree_row_pre_update: self.segment_tree_row_pre_update.clone(),
			segment_tree_row_post_update: self.segment_tree_row_post_update.clone(),
			segment_tree_row_pre_delete: self.segment_tree_row_pre_delete.clone(),
			segment_tree_row_post_delete: self.segment_tree_row_post_delete.clone(),
			segment_tree_post_create: self.segment_tree_post_create.clone(),
			segment_tree_pre_update: self.segment_tree_pre_update.clone(),
			segment_tree_post_update: self.segment_tree_post_update.clone(),
			segment_tree_pre_delete: self.segment_tree_pre_delete.clone(),
			...
			identity_attribute_post_create: self.identity_attribute_post_create.clone(),
			identity_attribute_pre_delete: self.identity_attribute_pre_delete.clone(),
			identity_attribute_value_post_create: self.identity_attribute_value_post_create.clone(),
