...
use crate::multi::transaction::serializable::{CommandTransaction, QueryTransaction, SerializableTransaction};

impl<MVS: MultiVersionStore, SVT: SingleVersionTransaction> WithEventBus for SerializableTransaction<MVS, SVT> {
...
impl<MVS: MultiVersionStore, SVT: SingleVersionTransaction> MultiVersionTransaction
	for SerializableTransaction<MVS, SVT>
{
