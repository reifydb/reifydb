...
test_each_path! { in "testing/tests/testscript/scripts" as scripts => test_testscript }
...
test_each_path! { for ["in", "out"] in "testing/tests/testscript/generate" as generate => test_generate }
...
// stored output.
test_each_path! { for ["in", "error"] in "testing/tests/testscript/errors" as errors => test_error }
