...
crate::rle_tests! {
	repeated: {
		let mut v = Vec::new();
		for val in [1_000_000_000_000i128, 2_000_000_000_000, 3_000_000_000_000, 4_000_000_000_000, 5_000_000_000_000] {
			v.extend(std::iter::repeat(val).take(100));
		}
		v
	},
	unique: (0..100).map(|i| i as i128 * 7 + 13).collect::<Vec<_>>(),
}
