...
#include "xxhash.h"
    ...
    (...)
    Xxh64HashT hash = XXH64(buffer, size, seed);
}
```
...
Xxh64HashT calcul_hash_streaming(FileHandler fh)
{
    /* create a hash state */
    ...
    Xxh64HashT const seed = 0;   /* or any other value */
    ...
    Xxh64HashT const hash = XXH64_digest(state);
