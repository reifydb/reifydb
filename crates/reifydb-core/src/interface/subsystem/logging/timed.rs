...
mod tests {
	use super::*;
	use crate::interface::subsystem::logging::mock::with_mock_logger;
	use crate::interface::subsystem::logging::LogLevel;
	use crate::{log_timed_debug, log_timed_info, log_timed_trace};
	...
	fn test_timed_log_returns_result() {
		...
		with_mock_logger(sender, || {
			// Test that the macro properly returns the result of the code block
