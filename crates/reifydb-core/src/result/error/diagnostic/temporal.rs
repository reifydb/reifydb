...
pub fn invalid_day<'a>(fragment: impl IntoFragment<'a>) -> Diagnostic {
	...
	Diagnostic {
		...
		statement: None,
		message: format!("invalid day value '{}'", fragment.fragment()),
		fragment,
		label,
...
pub fn invalid_hour<'a>(fragment: impl IntoFragment<'a>) -> Diagnostic {
	...
	Diagnostic {
        ...
        statement: None,
        message: format!("invalid hour value '{}'", fragment.fragment()),
        fragment,
        label,
        help: Some(
...
pub fn invalid_interval_character<'a>(
	...
	Diagnostic {
        ...
        statement: None,
        message: format!("invalid character in interval '{}'", fragment.fragment()),
        fragment,
        label,
