...
pub fn not_can_not_applied_to_number(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
...
pub fn not_can_not_applied_to_text(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn not_can_not_applied_to_temporal(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn not_can_not_applied_to_uuid(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn and_can_not_applied_to_number(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn and_can_not_applied_to_text(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn and_can_not_applied_to_temporal(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn and_can_not_applied_to_uuid(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn or_can_not_applied_to_number(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn or_can_not_applied_to_text(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn or_can_not_applied_to_temporal(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn or_can_not_applied_to_uuid(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn xor_can_not_applied_to_number(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn xor_can_not_applied_to_text(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn xor_can_not_applied_to_temporal(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
...
pub fn xor_can_not_applied_to_uuid(origin: impl IntoDiagnosticOrigin) -> Diagnostic {
	let origin = origin.into_origin();
	Diagnostic {
