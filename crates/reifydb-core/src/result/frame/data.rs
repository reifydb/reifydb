...
impl FrameColumnData {
    ...
    pub fn is_defined(&self, idx: usize) -> bool {
        match self {
            ...
            FrameColumnData::RowId(container) => container.is_defined(idx),
...
impl FrameColumnData {
    ...
    pub fn as_string(&self, index: usize) -> String {
        match self {
            ...
            FrameColumnData::RowId(container) => container.as_string(index),
...
impl FrameColumnData {
    pub fn get_value(&self, index: usize) -> Value {
        match self {
            ...
            FrameColumnData::RowId(container) => container.get_value(index),
