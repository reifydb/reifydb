...
mod tests {
	...
	#[test]
	fn test_basic() {
		let span = OwnedFragment::testing("2024-03-15T14:30:00");
	...
	fn test_with_timezone_z() {
		let span = OwnedFragment::testing("2024-03-15T14:30:00Z");
		let datetime = parse_datetime(span).unwrap();
		assert_eq!(
			datetime.to_string(),
			"2024-03-15T14:30:00.000000000Z"
	...
	fn test_with_milliseconds() {
		let span = OwnedFragment::testing("2024-03-15T14:30:00.123Z");
		let datetime = parse_datetime(span).unwrap();
		assert_eq!(
			datetime.to_string(),
	...
	fn test_with_microseconds() {
		let span = OwnedFragment::testing("2024-03-15T14:30:00.123456Z");
		let datetime = parse_datetime(span).unwrap();
		assert_eq!(
			datetime.to_string(),
	...
	fn test_with_nanoseconds() {
		let span = OwnedFragment::testing("2024-03-15T14:30:00.123456789Z");
		let datetime = parse_datetime(span).unwrap();
		assert_eq!(
			datetime.to_string(),
	...
	#[test]
	fn test_leap_year() {
		let span = OwnedFragment::testing("2024-02-29T00:00:00");
		let datetime = parse_datetime(span).unwrap();
		assert_eq!(
			datetime.to_string(),
	...
	#[test]
	fn test_boundaries() {
		let span = OwnedFragment::testing("2000-01-01T00:00:00");
		let datetime = parse_datetime(span).unwrap();
		assert_eq!(
			datetime.to_string(),
		...
		let span = OwnedFragment::testing("2024-12-31T23:59:59");
		let datetime = parse_datetime(span).unwrap();
		assert_eq!(
			datetime.to_string(),
	...
	fn test_invalid_date_format() {
		let span = OwnedFragment::testing("2024-03T14:30:00");
		let err = parse_datetime(span).unwrap_err();
	...
	fn test_invalid_time_format() {
		let span = OwnedFragment::testing("2024-03-15T14:30");
		let err = parse_datetime(span).unwrap_err();
	...
	fn test_invalid_year() {
		let span = OwnedFragment::testing("invalid-03-15T14:30:00");
		let err = parse_datetime(span).unwrap_err();
	...
	fn test_invalid_date_values() {
		let span = OwnedFragment::testing("2024-13-32T23:30:40");
		let err = parse_datetime(span).unwrap_err();
	...
	fn test_invalid_time_value() {
		let span = OwnedFragment::testing("2024-09-09T30:70:80");
		let err = parse_datetime(span).unwrap_err();
	...
	fn test_invalid_fractional_seconds() {
		let span = OwnedFragment::testing("2024-03-15T14:30:00.123.456");
		let err = parse_datetime(span).unwrap_err();
