	...
	fn push(&mut self, value: i16) {
		match self {
            ...
            ColumnData::Int4(container) => {
                match <i16 as SafeConvert<i32>>::checked_convert(value) {
                    Some(v) => container.push(v),
                    None => container.push_undefined()}
            }
            ColumnData::Int8(container) => {
                match <i16 as SafeConvert<i64>>::checked_convert(value) {
                    Some(v) => container.push(v),
                    None => container.push_undefined()}
            }
            ColumnData::Int16(container) => {
                match <i16 as SafeConvert<i128>>::checked_convert(value) {
                    Some(v) => container.push(v),
                    None => container.push_undefined()}
            }
