...
use crate::ast::{
	ast::*,
	identifier::{MaybeQualifiedColumnIdentifier, MaybeQualifiedFunctionIdentifier, UnresolvedPrimitiveIdentifier},
};
...
fn write_unresolved_id(buf: &mut FingerprintBuffer, id: &UnresolvedPrimitiveIdentifier<'_>) {
