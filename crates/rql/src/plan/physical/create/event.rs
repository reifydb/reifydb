...
use crate::{
	...
	nodes::{CreateEventNode, CreateSumTypeColumn, CreateSumTypeVariant},
	plan::{
		logical,
...
impl<'bump> Compiler<'bump> {
	pub(crate) fn compile_create_event(
		&mut self,
		rx: &mut Transaction<'_>,
		create: logical::CreateEventNode<'_>,
		...
		Ok(PhysicalPlan::CreateEvent(CreateEventNode {
