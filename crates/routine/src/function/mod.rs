...
pub fn default_native_functions(builder: RoutinesConfigurator) -> RoutinesConfigurator {
	builder.register_builtin_function(Arc::new(math::sum::Sum::new()))
		...
		.register_builtin_function(Arc::new(math::rem::default::RemDefault::new()))
		.register_builtin_function(Arc::new(math::rem::strict::RemStrict::new()))
		.register_builtin_function(Arc::new(math::rem::wrap::RemWrap::new()))
