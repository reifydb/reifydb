...
pub struct RemSaturate {
	info: RoutineInfo,
}

impl Default for RemSaturate {
	fn default() -> Self {
		Self::new()
	}
}
...
impl RemSaturate {
	pub fn new() -> Self {
		Self {
			info: RoutineInfo::new("math::rem_saturate"),
		}
	}
}

impl<'a> Routine<FunctionContext<'a>> for RemSaturate {
	...
	fn execute(&self, ctx: &mut FunctionContext<'a>, args: &Columns) -> Result<Columns, RoutineError> {
		dispatch_two::<RemOp>(ctx, args, BasicStrategy::Saturate)
	}
}

impl Function for RemSaturate {
