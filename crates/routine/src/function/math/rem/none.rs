...
impl RemNone {
	pub fn new() -> Self {
		Self {
			info: RoutineInfo::new("math::rem_none"),
		}
	}
}

impl<'a> Routine<FunctionContext<'a>> for RemNone {
	...
	fn execute(&self, ctx: &mut FunctionContext<'a>, args: &Columns) -> Result<Columns, RoutineError> {
		dispatch_two::<RemOp>(ctx, args, BasicStrategy::None)
	}
}

impl Function for RemNone {
