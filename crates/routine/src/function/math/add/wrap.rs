...
impl AddWrap {
	pub fn new() -> Self {
		Self {
			info: RoutineInfo::new("math::add_wrap"),
		}
	}
}

impl<'a> Routine<FunctionContext<'a>> for AddWrap {
	...
	fn execute(&self, ctx: &mut FunctionContext<'a>, args: &Columns) -> Result<Columns, RoutineError> {
		dispatch_two::<AddOp>(ctx, args, BasicStrategy::Wrap)
	}
}

impl Function for AddWrap {
