...
use reifydb_store_transaction::{
	CdcGet, CdcRange, CdcScan, CdcStore,
...
test_each_path! { in "crates/store-transaction/tests/scripts/backend/cdc" as backend_cdc_memory => test_memory }
test_each_path! { in "crates/store-transaction/tests/scripts/backend/cdc" as backend_cdc_sqlite => test_sqlite }
