...
use crate::grpc::client::grpc::command_result;
...
pub fn convert_result(result: command_result::Result, query: &str) -> Result<Frame, Error> {
    match result {
        ...
        command_result::Result::Frame(grpc_frame) => Ok(convert_frame(grpc_frame)),
    }
}
