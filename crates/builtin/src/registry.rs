...
use reifydb_catalog::function::registry::{Functions, FunctionsBuilder};

use crate::function::{
	blob, clock, date, datetime, duration, flow, identity, is, json, math, meta, rql, series, subscription,
	testing, text, time,
	uuid::{v4::UuidV4, v7::UuidV7},
};

pub fn default_functions() -> FunctionsBuilder {
