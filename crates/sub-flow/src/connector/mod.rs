...
//! Source and sink connector registry. Connectors defined through `reifydb-sdk` register here at
//! boot and are instantiated at flow start through their typed factory closures.
