...
mod tests {
	...
	fn test_commit_removes() {
		...
		let mut txn = FlowTransaction::new(&parent, commit_version, Catalog::default());
	...
	fn test_sequential_commits_different_keys() {
		...
		let mut txn1 = FlowTransaction::new(&parent, CommitVersion(1), Catalog::default());
		...
		let mut txn2 = FlowTransaction::new(&parent, CommitVersion(2), Catalog::default());
