...
pub fn create_host_callbacks() -> HostCallbacks {
	HostCallbacks {
		...
		state: StateCallbacks {
			...
			internal_drop: state::host_internal_state_drop,
			...
			drop_row_number: state::host_drop_row_number,
			drop_row_numbers_below: state::host_drop_row_numbers_below,
		},
		log: LogCallbacks {
