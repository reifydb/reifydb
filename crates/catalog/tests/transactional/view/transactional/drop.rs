...
const SETUP_V_B: &str =
	"CREATE TRANSACTIONAL VIEW vns_drop_b::v { id: int4 } AS { FROM vns_drop_b::src MAP { id: id } }";
const SETUP_V_C: &str =
	"CREATE TRANSACTIONAL VIEW vns_drop_c::v { id: int4 } AS { FROM vns_drop_c::src MAP { id: id } }";
const SETUP_V_D: &str =
	"CREATE TRANSACTIONAL VIEW vns_drop_d::v { id: int4 } AS { FROM vns_drop_d::src MAP { id: id } }";
