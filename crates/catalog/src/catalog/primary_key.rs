...
impl Catalog {
	...
	pub fn find_primary_key<T: IntoStandardTransaction>(
		&self,
		txn: &mut T,
	...
	pub fn list_primary_keys<T: IntoStandardTransaction>(&self, txn: &mut T) -> crate::Result<Vec<PrimaryKeyDef>> {
	...
	pub fn list_primary_key_columns<T: IntoStandardTransaction>(
		&self,
		txn: &mut T,
