...
impl Catalog {
	...
	pub fn delete_flow_edge(&self, txn: &mut StandardCommandTransaction, edge_id: FlowEdgeId) -> crate::Result<()> {
		CatalogStore::delete_flow_edge(txn, edge_id)
	}

	#[instrument(name = "catalog::flow_edge::find", level = "trace", skip(self, txn))]
	pub fn find_flow_edge<T: IntoStandardTransaction>(
		&self,
		txn: &mut T,
		edge_id: FlowEdgeId,
	...
	pub fn get_flow_edge<T: IntoStandardTransaction>(
		&self,
		txn: &mut T,
		edge_id: FlowEdgeId,
	...
	pub fn list_flow_edges_by_flow<T: IntoStandardTransaction>(
		&self,
		txn: &mut T,
		flow_id: FlowId,
	...
	pub fn list_flow_edges_all<T: IntoStandardTransaction>(&self, txn: &mut T) -> crate::Result<Vec<FlowEdgeDef>> {
