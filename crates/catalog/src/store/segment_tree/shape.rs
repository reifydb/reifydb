...
pub(crate) mod segment_tree {
	...
	pub(crate) const KEY_COLUMN: usize = 3;
	pub(crate) const KEY_KIND: usize = 4;
	pub(crate) const PRECISION: usize = 5;
	pub(crate) const PRIMARY_KEY: usize = 6;
	pub(crate) const PARTITION_BY: usize = 7;
	pub(crate) const UNDERLYING: usize = 8;
	pub(crate) const AGGREGATES: usize = 9;
	...
	pub(crate) static SHAPE: Lazy<RowShape> = Lazy::new(|| {
		RowShape::new(vec![
			...
			RowShapeField::unconstrained("aggregates", ValueType::Blob),
		])
	});
}

pub(crate) mod segment_tree_namespace {
	use super::*;
...
pub(crate) mod segment_tree_metadata {
	use super::*;
