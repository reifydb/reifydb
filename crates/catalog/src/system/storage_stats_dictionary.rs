...
use super::ids::table_virtual::DICTIONARY_STORAGE_STATS;

/// Returns the static definition for the system.dictionary_storage_stats virtual table
pub fn dictionary_storage_stats() -> Arc<TableVirtualDef> {
	...
	INSTANCE.get_or_init(|| {
		Arc::new(TableVirtualDef {
			...
			columns: vec![
				...
				ColumnDef {
					id: ColumnId(8),
					name: "current_entry_count".to_string(),
					constraint: TypeConstraint::unconstrained(Type::Uint8),
					policies: vec![],
					index: ColumnIndex(6),
					auto_increment: false,
				...
				ColumnDef {
					id: ColumnId(12),
					name: "historical_entry_count".to_string(),
					constraint: TypeConstraint::unconstrained(Type::Uint8),
					policies: vec![],
