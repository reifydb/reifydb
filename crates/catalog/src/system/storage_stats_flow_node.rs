...
use super::ids::table_virtual::FLOW_NODE_STORAGE_STATS;

/// Returns the static definition for the system.flow_node_storage_stats virtual table
pub fn flow_node_storage_stats() -> Arc<TableVirtualDef> {
