...
use super::ids::table_virtual::TABLE_STORAGE_STATS;

/// Returns the static definition for the system.table_storage_stats virtual table
pub fn table_storage_stats() -> Arc<TableVirtualDef> {
