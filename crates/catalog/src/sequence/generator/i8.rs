...
use reifydb_core::interface::{
    ActiveCommandTransaction, UnversionedCommandTransaction, UnversionedQueryTransaction,
...
static LAYOUT: Lazy<EncodedRowLayout> = Lazy::new(|| EncodedRowLayout::new(&[Type::Int1]));
...
mod tests {
    ...
    fn test_ok() {
        ...
        for expected in 1..100 {
            let got = GeneratorI8::next(&mut atx, &EncodedKey::new("sequence")).unwrap();
    ...
    fn test_exhaustion() {
        ...
        let err = GeneratorI8::next(&mut atx, &EncodedKey::new("sequence")).unwrap_err();
