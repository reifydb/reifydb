...
use super::{
	...
	system::{
		...
		primary_keys::SystemPrimaryKeys, primitive_retention_policies::SystemPrimitiveRetentionPolicies,
		...
		schemas::SystemSchemas, sequences::SystemSequences, series::SystemSeries,
...
pub enum VTables {
	...
	PrimitiveRetentionPolicies(SystemPrimitiveRetentionPolicies),
	...
	SchemaFields(SystemSchemaFields),
	Enums(SystemEnums),
