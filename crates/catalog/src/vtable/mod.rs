...
impl VTableRegistry {
	...
	pub fn find_vtable(_rx: &mut Transaction<'_>, id: VTableId) -> Result<Option<Arc<VTableDef>>> {
		Ok(match id {
			...
			IDENTITIES => Some(SystemCatalog::get_system_identities_table_def()),
			ROLES => Some(SystemCatalog::get_system_roles_table_def()),
			GRANTED_ROLES => Some(SystemCatalog::get_system_granted_roles_table_def()),
	...
	pub fn list_vtables(_rx: &mut Transaction<'_>) -> Result<Vec<Arc<VTableDef>>> {
		...
		Ok(vec![
			...
			SystemCatalog::get_system_identities_table_def(),
			SystemCatalog::get_system_roles_table_def(),
			SystemCatalog::get_system_granted_roles_table_def(),
