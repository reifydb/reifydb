...
impl<'a> ColumnComputed<'a> {
	pub fn bool(name: &str, data: impl IntoIterator<Item = bool>) -> Column<'a> {
		Column::Computed(Self {
	...
	pub fn float4(name: &str, data: impl IntoIterator<Item = f32>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn float8(name: &str, data: impl IntoIterator<Item = f64>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn int1(name: &str, data: impl IntoIterator<Item = i8>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn int2(name: &str, data: impl IntoIterator<Item = i16>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn int4(name: &str, data: impl IntoIterator<Item = i32>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn int8(name: &str, data: impl IntoIterator<Item = i64>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn int16(name: &str, data: impl IntoIterator<Item = i128>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn uint1(name: &str, data: impl IntoIterator<Item = u8>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn uint2(name: &str, data: impl IntoIterator<Item = u16>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn uint4(name: &str, data: impl IntoIterator<Item = u32>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn uint8(name: &str, data: impl IntoIterator<Item = u64>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn uint16(name: &str, data: impl IntoIterator<Item = u128>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn utf8<'b>(name: &str, data: impl IntoIterator<Item = &'b str>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn undefined(name: &str, len: usize) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	// Temporal types
	pub fn date(name: &str, data: impl IntoIterator<Item = Date>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn datetime(name: &str, data: impl IntoIterator<Item = DateTime>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn time(name: &str, data: impl IntoIterator<Item = Time>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn interval(name: &str, data: impl IntoIterator<Item = Interval>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	// UUID types
	pub fn uuid4(name: &str, data: impl IntoIterator<Item = Uuid4>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn uuid7(name: &str, data: impl IntoIterator<Item = Uuid7>) -> Column<'a> {
		Column::Computed(Self {
			name: Fragment::owned_internal(name),
	...
	pub fn row_number(data: impl IntoIterator<Item = RowNumber>) -> Column<'a> {
		Column::Computed(Self {
