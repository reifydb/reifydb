	...
	fn push(&mut self, value: u128) {
		match self {
            ...
            ColumnData::Uint2(container) => {
                match <u128 as SafeConvert<u16>>::checked_convert(value) {
                    Some(v) => container.push(v),
                    None => container.push_undefined()}
            }
            ColumnData::Uint4(container) => {
                match <u128 as SafeConvert<u32>>::checked_convert(value) {
                    Some(v) => container.push(v),
                    None => container.push_undefined()}
            }
            ColumnData::Uint8(container) => {
                match <u128 as SafeConvert<u64>>::checked_convert(value) {
                    Some(v) => container.push(v),
                    None => container.push_undefined()}
            }
