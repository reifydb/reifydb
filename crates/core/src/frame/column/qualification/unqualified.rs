use crate::{BitVec};
use super::super::{ColumnValues, ColumnUnqualified, NewFrameColumn};

impl ColumnUnqualified {
    pub fn bool(name: &str, values: impl IntoIterator<Item = bool>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn float4(name: &str, values: impl IntoIterator<Item = f32>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn float8(name: &str, values: impl IntoIterator<Item = f64>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn int1(name: &str, values: impl IntoIterator<Item = i8>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn int2(name: &str, values: impl IntoIterator<Item = i16>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn int4(name: &str, values: impl IntoIterator<Item = i32>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn int8(name: &str, values: impl IntoIterator<Item = i64>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn int16(name: &str, values: impl IntoIterator<Item = i128>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn uint1(name: &str, values: impl IntoIterator<Item = u8>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn uint2(name: &str, values: impl IntoIterator<Item = u16>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn uint4(name: &str, values: impl IntoIterator<Item = u32>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn uint8(name: &str, values: impl IntoIterator<Item = u64>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn uint16(name: &str, values: impl IntoIterator<Item = u128>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn utf8<'a>(name: &str, values: impl IntoIterator<Item = &'a str>) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
    ...
    pub fn undefined(name: &str, len: usize) -> NewFrameColumn {
        NewFrameColumn::Unqualified(Self {
            name: name.to_string(),
