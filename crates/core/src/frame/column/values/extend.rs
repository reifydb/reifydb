                ...
                match typed_r {
                    ColumnValues::Bool(r) => {
                        let mut new_container =
                            crate::frame::column::container::BoolContainer::with_capacity(
                                l_len + r.len(),
                            );
                    ...
                    ColumnValues::Float4(r) => {
                        let mut new_container =
                            crate::frame::column::container::NumberContainer::with_capacity(
                                l_len + r.len(),
                            );
                        new_container.extend_from_undefined(l_len);
                        new_container.extend(&r)?;
                    ...
                    ColumnValues::Utf8(r) => {
                        let mut new_container =
                            crate::frame::column::container::StringContainer::with_capacity(
                                l_len + r.len(),
                            );
                        new_container.extend_from_undefined(l_len);
                        new_container.extend(&r)?;
                    ...
                    ColumnValues::Date(r) => {
                        let mut new_container =
                            crate::frame::column::container::TemporalContainer::with_capacity(
                                l_len + r.len(),
                            );
                        new_container.extend_from_undefined(l_len);
                        new_container.extend(&r)?;
                    ...
                    ColumnValues::Uuid4(r) => {
                        let mut new_container =
                            crate::frame::column::container::UuidContainer::with_capacity(
                                l_len + r.len(),
                            );
                        new_container.extend_from_undefined(l_len);
                        new_container.extend(&r)?;
                    ...
                    ColumnValues::Blob(r) => {
                        let mut new_container =
                            crate::frame::column::container::BlobContainer::with_capacity(
                                l_len + r.len(),
                            );
                        new_container.extend_from_undefined(l_len);
                        new_container.extend(&r)?;
