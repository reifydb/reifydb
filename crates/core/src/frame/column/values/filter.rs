...
mod tests {
    ...
    fn test_filter_int4() {
        ...
        assert_eq!(col.len(), 3);
        assert_eq!(col.get_value(0), crate::Value::Int4(1));
        assert_eq!(col.get_value(1), crate::Value::Int4(3));
        assert_eq!(col.get_value(2), crate::Value::Int4(5));
    }
    ...
    fn test_filter_float4() {
        ...
        match col.get_value(1) {
            crate::Value::Float4(v) => assert_eq!(v.value(), 4.0),
            _ => panic!("Expected Float4"),
        }
    }
    ...
    fn test_filter_string() {
        ...
        assert_eq!(col.len(), 2);
        assert_eq!(col.get_value(0), crate::Value::Utf8("a".to_string()));
        assert_eq!(col.get_value(1), crate::Value::Utf8("d".to_string()));
    }
    ...
    fn test_filter_undefined() {
        ...
        assert_eq!(col.len(), 2);
        assert_eq!(col.get_value(0), crate::Value::Undefined);
        assert_eq!(col.get_value(1), crate::Value::Undefined);
    }
    ...
    fn test_filter_all_true_mask() {
        ...
        assert_eq!(col.len(), 3);
        assert_eq!(col.get_value(0), crate::Value::Int4(1));
        assert_eq!(col.get_value(1), crate::Value::Int4(2));
        assert_eq!(col.get_value(2), crate::Value::Int4(3));
    }
}
