    ...
    T: Clone + PartialEq,
{
    pub fn with_capacity(capacity: usize) -> Self {
        // Allocate with extra capacity to ensure alignment for SIMD operations
        // Round up capacity to next multiple of 8 for better cache performance
    ...
    pub fn with_aligned_capacity(capacity: usize) -> Self {
        ...
        // This ensures we can process data in chunks without bounds checking
