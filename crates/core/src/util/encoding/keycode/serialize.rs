...
use super::{
	encode_bool, encode_bytes, encode_f32, encode_f64, encode_i8, encode_i16, encode_i32, encode_i128, encode_u8,
	encode_u16, encode_u128,
};
...
impl ser::Serializer for &mut Serializer {
	...
	fn serialize_i64(self, v: i64) -> Result<()> {
		super::encode_i64_varint(v, &mut self.output);
		Ok(())
	}
	...
	fn serialize_u32(self, v: u32) -> Result<()> {
		super::encode_u32_varint(v, &mut self.output);
		Ok(())
	}

	fn serialize_u64(self, v: u64) -> Result<()> {
		super::encode_u64_varint(v, &mut self.output);
		Ok(())
	}
