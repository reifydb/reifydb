...
pub struct Interceptors<CT: CommandTransaction> {
	...
	pub ring_buffer_def_post_create: Chain<CT, dyn RingBufferDefPostCreateInterceptor<CT>>,
	pub ring_buffer_def_pre_update: Chain<CT, dyn RingBufferDefPreUpdateInterceptor<CT>>,
	pub ring_buffer_def_post_update: Chain<CT, dyn RingBufferDefPostUpdateInterceptor<CT>>,
	pub ring_buffer_def_pre_delete: Chain<CT, dyn RingBufferDefPreDeleteInterceptor<CT>>,
...
impl<CT: CommandTransaction> Interceptors<CT> {
	pub fn new() -> Self {
		Self {
			...
			ring_buffer_def_post_create: InterceptorChain::new(),
			ring_buffer_def_pre_update: InterceptorChain::new(),
			ring_buffer_def_post_update: InterceptorChain::new(),
			ring_buffer_def_pre_delete: InterceptorChain::new(),
...
impl<CT: CommandTransaction> Clone for Interceptors<CT> {
	fn clone(&self) -> Self {
		Self {
			...
			ring_buffer_def_post_create: self.ring_buffer_def_post_create.clone(),
			ring_buffer_def_pre_update: self.ring_buffer_def_pre_update.clone(),
			ring_buffer_def_post_update: self.ring_buffer_def_post_update.clone(),
			ring_buffer_def_pre_delete: self.ring_buffer_def_pre_delete.clone(),
