...
impl ColumnId {
	...
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_TS: ColumnId = ColumnId(1242);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_DOMAIN: ColumnId = ColumnId(1243);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_SHARD: ColumnId = ColumnId(1244);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_USED: ColumnId = ColumnId(1245);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_LIMIT: ColumnId = ColumnId(1246);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_PAGES: ColumnId = ColumnId(1247);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_PAGE_CAP: ColumnId = ColumnId(1248);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_PAYLOAD: ColumnId = ColumnId(1249);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_ENTRIES: ColumnId = ColumnId(1250);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_HOT_PAGES: ColumnId = ColumnId(1251);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_COMPLETE_PAGES: ColumnId = ColumnId(1252);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_BLOCKED_PAGES: ColumnId = ColumnId(1253);
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_WARMING: ColumnId = ColumnId(1254);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_TS: ColumnId = ColumnId(1255);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_DOMAIN: ColumnId = ColumnId(1256);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_SHARD: ColumnId = ColumnId(1257);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_STARTED: ColumnId = ColumnId(1258);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_COMPLETED: ColumnId = ColumnId(1259);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_DIRTY_ABORTED: ColumnId = ColumnId(1260);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_ABORTED: ColumnId = ColumnId(1261);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_BLOCKED_MARKS: ColumnId = ColumnId(1262);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_EVICTED_PAGES: ColumnId = ColumnId(1263);
	pub const READ_BUFFER_WARMS_SNAPSHOTS_INVALIDATED_COMPLETE_PAGES: ColumnId = ColumnId(1264);
	pub const READ_BUFFER_READS_SNAPSHOTS_TS: ColumnId = ColumnId(1265);
	pub const READ_BUFFER_READS_SNAPSHOTS_DOMAIN: ColumnId = ColumnId(1266);
	pub const READ_BUFFER_READS_SNAPSHOTS_SHARD: ColumnId = ColumnId(1267);
	pub const READ_BUFFER_READS_SNAPSHOTS_POINT_HITS: ColumnId = ColumnId(1268);
	pub const READ_BUFFER_READS_SNAPSHOTS_PREVIOUS_HITS: ColumnId = ColumnId(1269);
	pub const READ_BUFFER_READS_SNAPSHOTS_POINT_MISSES: ColumnId = ColumnId(1270);
	pub const READ_BUFFER_READS_SNAPSHOTS_RANGE_SERVED: ColumnId = ColumnId(1271);
	pub const READ_BUFFER_READS_SNAPSHOTS_RANGE_GAPS: ColumnId = ColumnId(1272);
	...
	pub const READ_BUFFER_SHARDS_SNAPSHOTS_COLUMNS: [ColumnId; 13] = [
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_TS,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_DOMAIN,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_SHARD,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_USED,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_LIMIT,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_PAGES,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_PAGE_CAP,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_PAYLOAD,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_ENTRIES,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_HOT_PAGES,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_COMPLETE_PAGES,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_BLOCKED_PAGES,
		Self::READ_BUFFER_SHARDS_SNAPSHOTS_WARMING,
	];

	pub const READ_BUFFER_WARMS_SNAPSHOTS_COLUMNS: [ColumnId; 10] = [
		Self::READ_BUFFER_WARMS_SNAPSHOTS_TS,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_DOMAIN,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_SHARD,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_STARTED,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_COMPLETED,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_DIRTY_ABORTED,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_ABORTED,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_BLOCKED_MARKS,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_EVICTED_PAGES,
		Self::READ_BUFFER_WARMS_SNAPSHOTS_INVALIDATED_COMPLETE_PAGES,
	];

	pub const READ_BUFFER_READS_SNAPSHOTS_COLUMNS: [ColumnId; 8] = [
		Self::READ_BUFFER_READS_SNAPSHOTS_TS,
		Self::READ_BUFFER_READS_SNAPSHOTS_DOMAIN,
		Self::READ_BUFFER_READS_SNAPSHOTS_SHARD,
		Self::READ_BUFFER_READS_SNAPSHOTS_POINT_HITS,
		Self::READ_BUFFER_READS_SNAPSHOTS_PREVIOUS_HITS,
		Self::READ_BUFFER_READS_SNAPSHOTS_POINT_MISSES,
		Self::READ_BUFFER_READS_SNAPSHOTS_RANGE_SERVED,
		Self::READ_BUFFER_READS_SNAPSHOTS_RANGE_GAPS,
	];
}
...
impl SeriesId {
	...
	pub const READ_BUFFER_SHARDS_SNAPSHOTS: SeriesId = SeriesId(1046);
	pub const READ_BUFFER_WARMS_SNAPSHOTS: SeriesId = SeriesId(1047);
	pub const READ_BUFFER_READS_SNAPSHOTS: SeriesId = SeriesId(1048);
...
const RESERVED_SOURCE_IDS: [u64; 27] = [
	...
	SeriesId::READ_BUFFER_SHARDS_SNAPSHOTS.0,
	SeriesId::READ_BUFFER_WARMS_SNAPSHOTS.0,
	SeriesId::READ_BUFFER_READS_SNAPSHOTS.0,
];
...
const RESERVED_COLUMN_GROUPS: [&[ColumnId]; 26] = [
