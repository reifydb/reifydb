...
const RESERVED_SOURCE_IDS: [u64; 21] = [
...
const RESERVED_COLUMN_GROUPS: [&[ColumnId]; 20] = [
...
mod reserved_id_tests {
	...
	fn reserved_series_ids() -> [SeriesId; 19] {
		[
	...
	fn reserved_column_arrays() -> [&'static [ColumnId]; 19] {
		[
			&ColumnId::PROFILER_QUERY_SNAPSHOTS_COLUMNS,
			&ColumnId::PROFILER_TXN_SNAPSHOTS_COLUMNS,
			&ColumnId::PROFILER_STORAGE_SNAPSHOTS_COLUMNS,
	...
	fn system_column_ids_are_reserved_unique_and_below_user_range() {
		...
		assert_eq!(count, 17 * 22 + 2 * 5, "expected exactly 384 reserved system column ids");
	}

	#[test]
	fn profiler_snapshot_arrays_have_22_columns_and_runtime_have_5() {
		for array in &reserved_column_arrays()[..17] {
