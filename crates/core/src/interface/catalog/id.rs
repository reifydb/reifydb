...
const RESERVED_NAMESPACE_IDS: [u64; 46] = [
	NamespaceId::ROOT.0,
	...
	NamespaceId::SYSTEM_METRICS_STORE_OPERATOR_COMMIT.0,
	NamespaceId::SYSTEM_METRICS_STORE_OPERATOR_READ.0,
	NamespaceId::SYSTEM_METRICS_STORE_OPERATOR_READ_KEYSPACE.0,
