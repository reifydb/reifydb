...
impl ColumnId {
	...
	pub const READ_BUFFER_SNAPSHOTS_LIMIT: ColumnId = ColumnId(1070);
	pub const READ_BUFFER_SNAPSHOTS_PAGES: ColumnId = ColumnId(1071);
	pub const READ_BUFFER_SNAPSHOTS_PAGE_CAP: ColumnId = ColumnId(1072);
	pub const READ_BUFFER_SNAPSHOTS_PAYLOAD: ColumnId = ColumnId(1073);
	pub const READ_BUFFER_SNAPSHOTS_ENTRIES: ColumnId = ColumnId(1074);
	pub const READ_BUFFER_SNAPSHOTS_HOT_PAGES: ColumnId = ColumnId(1075);
	pub const READ_BUFFER_SNAPSHOTS_COMPLETE_PAGES: ColumnId = ColumnId(1076);
	pub const READ_BUFFER_SNAPSHOTS_BLOCKED_PAGES: ColumnId = ColumnId(1077);
	pub const READ_BUFFER_SNAPSHOTS_WARMING: ColumnId = ColumnId(1078);
	pub const READ_BUFFER_SNAPSHOTS_WARMS_STARTED: ColumnId = ColumnId(1079);
	pub const READ_BUFFER_SNAPSHOTS_WARMS_COMPLETED: ColumnId = ColumnId(1080);
	pub const READ_BUFFER_SNAPSHOTS_WARMS_DIRTY_ABORTED: ColumnId = ColumnId(1081);
	pub const READ_BUFFER_SNAPSHOTS_WARMS_ABORTED: ColumnId = ColumnId(1082);
	pub const READ_BUFFER_SNAPSHOTS_PAGES_WARM_BLOCKED: ColumnId = ColumnId(1083);
	pub const READ_BUFFER_SNAPSHOTS_PAGES_EVICTED: ColumnId = ColumnId(1084);
	pub const READ_BUFFER_SNAPSHOTS_COMPLETE_PAGES_INVALIDATED: ColumnId = ColumnId(1085);
	pub const READ_BUFFER_SNAPSHOTS_POINT_HITS: ColumnId = ColumnId(1086);
	pub const READ_BUFFER_SNAPSHOTS_PREVIOUS_HITS: ColumnId = ColumnId(1087);
	pub const READ_BUFFER_SNAPSHOTS_POINT_MISSES: ColumnId = ColumnId(1088);
	pub const READ_BUFFER_SNAPSHOTS_RANGE_SERVED: ColumnId = ColumnId(1089);
	pub const READ_BUFFER_SNAPSHOTS_RANGE_GAPS: ColumnId = ColumnId(1090);
	...
	pub const LIFECYCLE_SNAPSHOTS_FREELIST_PAGES: ColumnId = ColumnId(1103);
	pub const LIFECYCLE_SNAPSHOTS_PAGE_COUNT: ColumnId = ColumnId(1104);
	...
	pub const READ_BUFFER_SNAPSHOTS_COLUMNS: [ColumnId; 24] = [
		Self::READ_BUFFER_SNAPSHOTS_TS,
		Self::READ_BUFFER_SNAPSHOTS_SHARD,
		Self::READ_BUFFER_SNAPSHOTS_USED,
		Self::READ_BUFFER_SNAPSHOTS_LIMIT,
		Self::READ_BUFFER_SNAPSHOTS_PAGES,
		Self::READ_BUFFER_SNAPSHOTS_PAGE_CAP,
		Self::READ_BUFFER_SNAPSHOTS_PAYLOAD,
		Self::READ_BUFFER_SNAPSHOTS_ENTRIES,
		Self::READ_BUFFER_SNAPSHOTS_HOT_PAGES,
		Self::READ_BUFFER_SNAPSHOTS_COMPLETE_PAGES,
		Self::READ_BUFFER_SNAPSHOTS_BLOCKED_PAGES,
		Self::READ_BUFFER_SNAPSHOTS_WARMING,
		Self::READ_BUFFER_SNAPSHOTS_WARMS_STARTED,
		Self::READ_BUFFER_SNAPSHOTS_WARMS_COMPLETED,
		Self::READ_BUFFER_SNAPSHOTS_WARMS_DIRTY_ABORTED,
		Self::READ_BUFFER_SNAPSHOTS_WARMS_ABORTED,
		Self::READ_BUFFER_SNAPSHOTS_PAGES_WARM_BLOCKED,
		Self::READ_BUFFER_SNAPSHOTS_PAGES_EVICTED,
		Self::READ_BUFFER_SNAPSHOTS_COMPLETE_PAGES_INVALIDATED,
		Self::READ_BUFFER_SNAPSHOTS_POINT_HITS,
		Self::READ_BUFFER_SNAPSHOTS_PREVIOUS_HITS,
		Self::READ_BUFFER_SNAPSHOTS_POINT_MISSES,
		Self::READ_BUFFER_SNAPSHOTS_RANGE_SERVED,
		Self::READ_BUFFER_SNAPSHOTS_RANGE_GAPS,
	];
	...
	pub const LIFECYCLE_SNAPSHOTS_COLUMNS: [ColumnId; 12] = [
		...
		Self::LIFECYCLE_SNAPSHOTS_FREELIST_PAGES,
		Self::LIFECYCLE_SNAPSHOTS_PAGE_COUNT,
...
impl SeriesId {
	...
	pub const READ_BUFFER_SNAPSHOTS: SeriesId = SeriesId(1029);
...
const RESERVED_SOURCE_IDS: [u64; 12] = [
	...
	SeriesId::READ_BUFFER_SNAPSHOTS.0,
