...
impl ColumnId {
	...
	pub const FLOW_STATE_SNAPSHOTS_NAME: ColumnId = ColumnId(1143);
	pub const FLOW_STATE_SNAPSHOTS_UNMANAGED_BECAUSE: ColumnId = ColumnId(1144);
	...
	pub const FLOW_STATE_SNAPSHOTS_COLUMNS: [ColumnId; 10] = [
		Self::FLOW_STATE_SNAPSHOTS_TS,
		Self::FLOW_STATE_SNAPSHOTS_OPERATOR,
		Self::FLOW_STATE_SNAPSHOTS_NAME,
		Self::FLOW_STATE_SNAPSHOTS_UNMANAGED_BECAUSE,
