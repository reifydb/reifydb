...
pub fn invalid_datetime_format(span: Span) -> Diagnostic {
    let label = Some(format!("expected YYYY-MM-DDTHH:MM:SS format, found '{}'", span.fragment));
    Diagnostic {
...
pub fn invalid_time_format(span: Span) -> Diagnostic {
    let label = Some(format!("expected HH:MM:SS format, found '{}'", span.fragment));
    Diagnostic {
...
pub fn invalid_year(span: Span) -> Diagnostic {
    let label = Some(format!("year '{}' cannot be parsed as a number", span.fragment));
    Diagnostic {
        code: "TEMPORAL_005".to_string(),
        statement: None,
        message: format!("invalid year value '{}'", span.fragment),
        span: Some(span),
        label,
...
pub fn invalid_month(span: Span) -> Diagnostic {
    let label =
        Some(format!("month '{}' cannot be parsed as a number (expected 1-12)", span.fragment));
    Diagnostic {
        code: "TEMPORAL_006".to_string(),
        statement: None,
        message: format!("invalid month value '{}'", span.fragment),
        span: Some(span),
        label,
...
pub fn invalid_day(span: Span) -> Diagnostic {
    let label =
        Some(format!("day '{}' cannot be parsed as a number (expected 1-31)", span.fragment));
    Diagnostic {
        code: "TEMPORAL_007".to_string(),
        statement: None,
        message: format!("invalid day value '{}'", span.fragment),
        span: Some(span),
        label,
...
pub fn invalid_hour(span: Span) -> Diagnostic {
    let label =
        Some(format!("hour '{}' cannot be parsed as a number (expected 0-23)", span.fragment));
    Diagnostic {
        code: "TEMPORAL_008".to_string(),
        statement: None,
        message: format!("invalid hour value '{}'", span.fragment),
        span: Some(span),
        label,
        help: Some(
...
pub fn invalid_minute(span: Span) -> Diagnostic {
    let label =
        Some(format!("minute '{}' cannot be parsed as a number (expected 0-59)", span.fragment));
    Diagnostic {
        code: "TEMPORAL_009".to_string(),
        statement: None,
        message: format!("invalid minute value '{}'", span.fragment),
        span: Some(span),
        label,
...
pub fn invalid_second(span: Span) -> Diagnostic {
    let label =
        Some(format!("second '{}' cannot be parsed as a number (expected 0-59)", span.fragment));
    Diagnostic {
        code: "TEMPORAL_010".to_string(),
        statement: None,
        message: format!("invalid second value '{}'", span.fragment),
        span: Some(span),
        label,
...
pub fn invalid_fractional_seconds(span: Span) -> Diagnostic {
    let label =
        Some(format!("fractional seconds '{}' cannot be parsed as a number", span.fragment));
    Diagnostic {
        code: "TEMPORAL_011".to_string(),
        statement: None,
        message: format!("invalid fractional seconds value '{}'", span.fragment),
        span: Some(span),
        label,
...
pub fn invalid_date_values(span: Span) -> Diagnostic {
    let label = Some(format!("date '{}' represents an invalid calendar date", span.fragment));
    Diagnostic {
...
pub fn invalid_time_values(span: Span) -> Diagnostic {
    let label = Some(format!("time '{}' contains out-of-range values", span.fragment));
    Diagnostic {
...
pub fn invalid_interval_character(span: Span) -> Diagnostic {
    let label = Some(format!("character '{}' is not valid in ISO 8601 duration", span.fragment));
    Diagnostic {
        code: "TEMPORAL_014".to_string(),
        statement: None,
        message: format!("invalid character in interval '{}'", span.fragment),
        span: Some(span),
        label,
...
pub fn incomplete_interval_specification(span: Span) -> Diagnostic {
    let label = Some(format!("number '{}' is missing a unit specifier", span.fragment));
    Diagnostic {
...
pub fn invalid_unit_in_context(span: Span, unit: char, in_time_part: bool) -> Diagnostic {
    let context = if in_time_part { "time part (after T)" } else { "date part (before T)" };
    let allowed = if in_time_part { "H, M, S" } else { "Y, M, W, D" };
    let label = Some(format!("unit '{}' is not allowed in the {}", unit, context));
    Diagnostic {
...
pub fn invalid_interval_component_value(span: Span, unit: char) -> Diagnostic {
    let label =
        Some(format!("{} value '{}' cannot be parsed as a number", unit_name(unit), span.fragment));
    Diagnostic {
        code: "TEMPORAL_017".to_string(),
        statement: None,
        message: format!("invalid {} value '{}'", unit_name(unit), span.fragment),
        span: Some(span),
        label,
...
pub fn unrecognized_temporal_pattern(span: Span) -> Diagnostic {
    let label = Some(format!("value '{}' does not match any temporal format", span.fragment));
    Diagnostic {
...
pub fn empty_date_component(span: Span) -> Diagnostic {
    let label = Some(format!("date component '{}' is empty", span.fragment));
    Diagnostic {
...
pub fn empty_time_component(span: Span) -> Diagnostic {
    let label = Some(format!("time component '{}' is empty", span.fragment));
    Diagnostic {
