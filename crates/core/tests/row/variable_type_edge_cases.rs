...
fn test_int_storage_modes() {
	...
	// Every int up to 76 digits sits in the fixed slot, so small, i128 edge and 54 digit values must all round
	// trip.
	...
	let huge = "999999999999999999999999999999999999999999999999999999".parse::<Int>().unwrap();
