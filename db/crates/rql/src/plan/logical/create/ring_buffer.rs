...
use crate::{
	...
	plan::logical::{
		Compiler, CreateRingBufferNode, LogicalPlan, convert_policy,
		resolver::IdentifierResolver,
	},
};

impl Compiler {
	pub(crate) fn compile_create_ring_buffer<
		'a,
		't,
	...
	>(
		...
		let ring_buffer = resolver
			.resolve_maybe_qualified_ring_buffer(
				&ast.ring_buffer,
				false,
			)?;
