...
test_each_path! { in "testsuite/functional/tests/scripts" as svl_memory => test_embedded_svl_memory }
test_each_path! { in "testsuite/functional/tests/scripts" as mvcc_memory => test_embedded_mvcc_memory }
