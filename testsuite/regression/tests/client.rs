...
test_each_path! { in "testsuite/regression/tests/scripts" as client_optimistic_lmdb => test_optimistic_lmdb }
...
test_each_path! { in "testsuite/regression/tests/scripts" as client_serializable_lmdb => test_serializable_lmdb }
