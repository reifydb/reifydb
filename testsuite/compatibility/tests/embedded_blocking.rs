...
test_each_path! { in "testsuite/compatibility/tests/scripts" as embedded_blocking_optimistic_lmdb => test_optimistic_lmdb }
...
test_each_path! { in "testsuite/compatibility/tests/scripts" as embedded_blocking_serializable_memory => test_serializable_memory }
test_each_path! { in "testsuite/compatibility/tests/scripts" as embedded_blocking_serializable_lmdb => test_serializable_lmdb }
