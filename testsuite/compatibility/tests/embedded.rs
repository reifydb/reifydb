...
test_each_path! { in "testsuite/compatibility/tests/scripts" as embedded_optimistic_memory => test_optimistic_memory }
...
test_each_path! { in "testsuite/compatibility/tests/scripts" as embedded_serializable_memory => test_serializable_memory }
test_each_path! { in "testsuite/compatibility/tests/scripts" as embedded_serializable_lmdb => test_serializable_lmdb }
