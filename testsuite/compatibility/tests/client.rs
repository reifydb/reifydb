...
test_each_path! { in "testsuite/compatibility/tests/scripts" as client_optimistic_memory => test_optimistic_memory }
test_each_path! { in "testsuite/compatibility/tests/scripts" as client_optimistic_lmdb => test_optimistic_lmdb }
