...
// test_each_path! { in "testsuite/functional/tests/scripts" as client_serializable_memory => test_serializable_memory }
...
// test_each_path! { in "testsuite/functional/tests/scripts" as client_svl_lmdb => test_svl_lmdb }
